...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "Simplecam")
        
        let topRatedNavigationController = storyboard.instantiateViewControllerWithIdentifier("MoviesNavigationController") as! UINavigationController
        let topRatedViewController = topRatedNavigationController.topViewController as! MoviesViewController
        topRatedViewController.endpoint = "top_rated"
        topRatedNavigationController.tabBarItem.title = "All-Time Top Rated"
        topRatedNavigationController.tabBarItem.image = UIImage(named: "Lovestage copy")
        ...
        upcomingNavigationController.tabBarItem.title = "Upcoming Movies"
        upcomingNavigationController.tabBarItem.image = UIImage(named: "Mixpanel")
